...
MEM1 BYTE "ABDUL SAMAD (19k-1396)",0
MEM2 BYTE "ASHMAL ANIS (19k-0305)",0
MEM3 BYTE "HASNAIN SOMANI(19k-0204)",0
var BYTE 15
S1 BYTE "________",0
S2 BYTE "|",0
S3 BYTE "@",0
S4 BYTE "/ \",0
S5 BYTE " ______|______",0
S6 BYTE "|_____________|",0
...
i3 byte "Please note that the maximum numbers of wrong choices input can be 5.",0
